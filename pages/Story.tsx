                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-6 text-neutral-600 leading-relaxed">
                        ...
                        <div className="pt-6 flex items-center gap-4">
                            ...
                            <div>
                                <p className="font-serif font-bold text-brand-dark">Yamuna Mahendra</p>
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-10 -left-10 bg-brand-cream p-8 rounded-xl shadow-lg max-w-xs -rotate-2">
                            <p className="font-serif italic text-brand-dark text-lg">"Nature's wisdom, bottled with care."</p>
                        </div>
                    </div>
                </div>
            </div>
