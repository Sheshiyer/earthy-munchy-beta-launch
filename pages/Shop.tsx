...
const Shop: React.FC = () => {
    ...
    const sortedProducts = [...filteredProducts].sort((a, b) => {
        // Honey Vault first
        if (a.id === 'honey-vault') return -1;
        if (b.id === 'honey-vault') return 1;
        // Wildflower honey second
        if (a.id === 'wildflower-honey') return -1;
        if (b.id === 'wildflower-honey') return 1;
        // Cinnamon Powder last
        if (a.id === 'cinnamon-powder') return 1;
        if (b.id === 'cinnamon-powder') return -1;
        return 0;
    });
